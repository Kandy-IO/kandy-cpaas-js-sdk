...
The [call.getById][11] API can be used to retrieve the
...
obtained through the [Conversation.getMessages][54] or [Conversation.getMessage][56] API on an existing conversation.
