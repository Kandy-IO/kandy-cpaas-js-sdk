...
obtained through the [Conversation.getMessages][63] or [Conversation.getMessage][64] API on an existing conversation.
...
[Conversation.createMessage][60] and [Message.send][62] functions.
...
-   `messages` **[Array][12]&lt;[conversation.Message][66]>** The array of message objects.
...
If successful, the event [messages:change][67] will be emitted.
...
Returns **[conversation.Message][66]** The newly created Message object.
...
Returns **[Array][12]&lt;[conversation.Message][66]>** An array of messages.
...
Returns **[conversation.Message][66]** A message object.
...
If successful, the event [isTypingList:change][68] will be emitted.
...
[64]: #conversationconversationgetmessage

[65]: #conversationpart

[66]: #conversationmessage

[67]: #conversationeventmessageschange

[68]: #conversationeventistypinglistchange
