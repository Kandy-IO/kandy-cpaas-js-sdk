...
Once all the desired parts have been added to it using the [MessageSender.addPart][41],
...
obtained through the [Conversation.getMessages][39] or [Conversation.getMessage][42] API on an existing conversation.
