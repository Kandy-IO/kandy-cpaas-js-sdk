...
Once we have authenticated, we can subscribe for notifications on the services we care about. In this case, we are subscribing to the `call` service on the `websocket` channel.
