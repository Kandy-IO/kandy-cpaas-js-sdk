...
client.on('group:new', function (params) {
  ...
  if (params.error) {
    ...
    log('Successfully created the group with name: ' + groupNameTxt + '. Its generated ID is: ' + params.groupId)
  }
