...
* Open as many browser instances of Google Chrome®, or [another supported browser](get-started), as the number of users in a group you want to have, by clicking __Try it__ that many times.
