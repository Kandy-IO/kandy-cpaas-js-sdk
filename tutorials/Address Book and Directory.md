...
#### Login
* Enter your Account Client ID for your account or project in the "Client ID" field.
...
* Search results should appear in the dropdown list labelled *Users* and the selected user will be rendered on the page.

#### Address Book
* Click the *Address Book* radio button to add more contacts in your user's personal address book.
* Enter the following details to add a contact:
  * ID (required - it should be unique for every contacts added)
...
* You can also update an added contact if any field is missing or needs alteration, by clicking on Update button. Please note that the ID field must match the contact whose information you wish to update.
