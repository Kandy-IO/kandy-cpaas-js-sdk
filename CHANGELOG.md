...
- Added new call events: `call:tracksAdded` and `call:tracksRemoved`
  ...
  - For more information, please see the [API documentation](https://kandy-io.github.io/kandy-cpaas-js-sdk/docs/#calleventcalltracksadded) for these events.
- Added new track event: `media:trackEnded`
  ...
  - For more information, please see the [API documentation](https://kandy-io.github.io/kandy-cpaas-js-sdk/docs/#mediaeventmediatrackEnded) for this event.
